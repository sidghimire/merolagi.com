...
$getInfo = "SELECT * FROM `product_info` where id='" . $_GET['productId'] . "'";
$getInfo = mysqli_query($conn2, $getInfo);
$getInfoData = mysqli_fetch_assoc($getInfo);
$getFeatures = "SELECT * FROM `product_features` where productUniqueId='" . $getInfoData['productUniqueId'] . "'";
$getFeatures = mysqli_query($conn2, $getFeatures);
$getImages = "SELECT * FROM `product_images` where productUniqueId='" .  $getInfoData['productUniqueId'] . "'";
...
<head>
    ...
    <script src="/frontend/productDetail/script.js"></script>
    <link rel="stylesheet" href="/frontend/productDetail/style.css">
    ...
    <meta name="Keywords" content="<?php echo ucwords($getInfoData['productName']) ?>,merolagi, find a job, realestate, buy products, nepal">
    <meta property="og:title" content="<?php echo ucwords($getInfoData['productName']) ?>" />
    ...
    <title><?php echo ucwords($getInfoData['productName']) ?></title>
</head>
...
<body>
    ...
    ?>
            <script>
                alertify.alert("Successfully Ordered For This Product.<br> You Will Get A Call/ Email").setHeader("Merolagi.com");
            </script>
    <?php
        }
        ...
        <div class="row no-gutters">
            <div class="col-md-4  text-center">
                <div class="l-main-image-container">
                    <img src="/res/database/productImages/<?php echo $getImagesData['imageName'] ?>" class="img-fluid " alt="<?php echo ucwords($getInfoData['productName']) ?>">
                </div>
...
<?php
            ...
            <div class="col-md-4 text-center">
                ...
                <?php
                $getEmployerId = "SELECT employerUniqueId FROM `product_info` where productUniqueId='" . $getInfoData['productUniqueId'] . "'";
        ...
        <form method="POST" action="/frontend/productDetail/action.php">
            <div class="modal fade" id="negotiateProducts">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="modal-title">Negotiate Product</div>
                        </div>
                        <div class="modal-body row no-gutters">
                            ...
                            <div class="l-company-div text-center col-md-6">
                                ...
                                <div class="container-fluid text-left l-make-deal-div">
                                    ...
                                    ?>
                                        <span class="l-product-detail-title">Product Detail:</span>
                                        <span class="l-product-modal-title">Product Name:<span class="l-product-modal-label"><?php echo ucwords($getInfoData['productName']) ?></span></span>
                                        ...
                                        <span class="l-product-modal-title" required>What Price Do You Want The Product For: <input type="number" placeholder="Price" class="form-control" name="price" required></span>
                            ...
                            <div class="l-company-div text-center col-md-6">
                                ...
                                <div class="container-fluid text-left l-make-deal-div">
                                    ...
                                    ?>
                                        ...
                                        <span class="l-product-modal-title">Quantity: <input type="number" placeholder="Quantity" class="form-control" name="quantity" required></span>
        ...
        <div class="row no-gutters l-section-2">
            <div class="col-md-7">
                ...
                ?>
                    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                    <ins class="adsbygoogle" style="display:block; text-align:center;" data-ad-layout="in-article" data-ad-format="fluid" data-ad-client="ca-pub-3866603838151846" data-ad-slot="2335056169"></ins>
                    <script>
                        (adsbygoogle = window.adsbygoogle || []).push({});
                    </script>
                <?php
