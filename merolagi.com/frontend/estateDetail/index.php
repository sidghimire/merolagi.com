...
$getInfo = "SELECT * FROM `realestate_info` where id='" . $_GET['productId'] . "'";
$getInfo = mysqli_query($conn2, $getInfo);
$getInfoData = mysqli_fetch_assoc($getInfo);
$getFeatures = "SELECT * FROM `realestate_features` where productUniqueId='" . $getInfoData['productUniqueId'] . "'";
$getFeatures = mysqli_query($conn2, $getFeatures);
$getImages = "SELECT * FROM `realestate_images` where productUniqueId='" .$getInfoData['productUniqueId'] . "'";
...
<head>
    ...
    <script src="/frontend/estateDetail/script.js"></script>
    <link rel="stylesheet" href="/frontend/estateDetail/style.css">
    ...
    <meta name="Keywords" content="<?php echo ucwords($getInfoData['estateTitle']) ?>,merolagi, find a job, realestate, buy products, nepal">
    <meta property="og:title" content="<?php echo ucwords($getInfoData['estateTitle']) ?>" />
    <meta property="og:url" content="<?php echo "https://merolagi.com/productdetail/" . $_GET['productId'] ?>" />
    <meta property="og:image" content="https://merolagi.com/res/database/productImages/<?php echo $getImagesData['imageName'] ?>" />

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo ucwords($getInfoData['estateTitle']) ?></title>
</head>
...
<body>
    ...
    ?>
            <script>
                alertify.alert("Successfully Requested For This Estate.<br> You Will Get A Call/ Email").setHeader("Merolagi.com");
            </script>
    <?php
        }
        ...
        <div class="row no-gutters">
            <div class="col-md-4  text-center">
                <div class="l-main-image-container">
                    <img src="/res/database/estateImages/<?php echo $getImagesData['imageName'] ?>" class="img-fluid " alt="<?php echo ucwords($getInfoData['estateTitle']) ?>">
                </div>
            ...
            <div class="col-md-4 l-product-detail-div">
                ...
                <span class="l-product-name"><?php echo ucwords($getInfoData['estateTitle']) ?></span>
...
?>
            ...
            <div class="col-md-4 text-center">
                <div class="l-contact-seller-div text-center row no-gutters">
                    <button type="button" class="btn btn-success l-buy-btn row no-gutters" style="padding: 10px;" data-target="#makeADeal" data-toggle="modal" onclick="getLocationBasic()">Make A Deal</button>
                ...
                <?php
                $getEmployerId = "SELECT employerUniqueId FROM `realestate_info` where productUniqueId='" . $getInfoData['productUniqueId'] . "'";
        ...
        <form method="POST" action="/frontend/estateDetail/action.php">
            <div class="modal fade" id="makeADeal">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="modal-title">Are Your Sure You Want To Make A Deal?</div>
                        </div>
                        <div class="modal-body row no-gutters">
                            ...
                            <div class="l-company-div text-center col-md-6">
                                ...
                                <div class="container-fluid text-left l-make-deal-div">
                                    ...
                                    ?>
                                        <span class="l-product-detail-title">Estate Detail:</span>
                                        <span class="l-product-modal-title">Estate Title:<span class="l-product-modal-label"><?php echo ucwords($getInfoData['estateTitle']) ?></span></span>
                        ...
                        <div class="modal-footer">
                            ...
                            if (isset($_SESSION['employerId'])) {
                            ?>
                                <button type="submit" class="btn btn-success" name="makeADeal">Make A Deal</button>
                            <?php
                            }
                            ?>
        ...
        <form method="POST" action="/frontend/estateDetail/action.php">
            <div class="modal fade" id="negotiateProducts">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="modal-title">Negotiate Estate</div>
                        </div>
                        <div class="modal-body row no-gutters">
                            <div class="l-company-div text-center col-md-6">
                            ...
                            <div class="l-company-div text-center col-md-6">
                                ...
                                <div class="container-fluid text-left l-make-deal-div">
                                    ...
                                    ?>
                                        <span class="l-product-detail-title">Estate Detail:</span>
                                        <span class="l-product-modal-title">Estate Name:<span class="l-product-modal-label"><?php echo ucwords($getInfoData['estateTitle']) ?></span></span>
                                        <span class="l-product-modal-title"> Price:<span class="l-product-modal-label"><?php echo $getInfoData['currency'] ?><?php echo $getInfoData['price'] ?>
                                            </span>
                                        </span>
                                        <span class="l-product-modal-title" required>What Price Do You Want The Estate For: <input type="number" placeholder="Price" class="form-control" name="price" required></span>
        ...
        <div class="row no-gutters l-section-2">
            <div class="col-md-7">
                <span class="l-crimson-title">Estate Details</span>
                <div class="l-product-info-table">
                    <span class="l-product-info-table-item row no-gutters">
                            <span class="l-product-label-2 col-5">Phone No:</span>
                            <span class=" col-7"><?php echo ucwords($getInfoData['phoneNo']) ?></span>
                    </span>
                    <?php
...
?>
                ...
                <div class="container-fluid l-main-image">
                    ...
                    ?>
                        <img src="/res/database/estateImages/<?php echo $getImagesData['imageName'] ?>" class="img-fluid l-main-image" alt="">
                    <?php
                    }
                    ?>
                </div>
