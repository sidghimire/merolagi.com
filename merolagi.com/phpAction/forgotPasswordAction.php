...
?><?php
    ...
    if (mysqli_num_rows($loginSql) == 1) {
        ...
        $resetSql = "INSERT INTO `employer_login_reset`(`email`, `token`, `sentDate`, `currentState`) VALUES ('" . $email . "','" . $token . "','" . date("Y/m/d") . "','YES')";
		...
		<tbody> 
			...
			<tr style="display: inline-block;"> 
				<td style="height: 150px; 
					...
					<p> 
						<a href= 
"https://www.merolagi.com/activate/resetEmployerPassword/resetPassword.php?token=' . $token . '"
