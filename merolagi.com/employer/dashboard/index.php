...
<body>
    ...
    <div class="l-container-padding text-center container-fluid">
        <div class=" l-container-title container-fluid text-left">
            <span class=" l-container-title-text">Sell Products Here</span>
        </div>
        <form action="action.php" method="POST" enctype="multipart/form-data" class=" l-main-container-section row no-gutters container-fluid" id="sellDiv">
            <div class="col-md-6" style="padding: 5px;">
                <div class="l-product-detail-container">
                    <div class="container-fluid text-center">
                        <input type="button" name="sellBtn" value="Click Here To Sell At Certain Location" onclick="getLocation();" data-toggle="modal" data-target="#mapping-div" class="btn btn-success w-100">
                    </div>
                    <input type="text" class="form-control l-form-control" placeholder="Product Name" name="productName" maxlength="50" required>
                    ...
                    <br>
                    <br>
                    <textarea name="productDescription" class="w-100" id="productDescription" rows="10" cols="90" required></textarea>
                    <script>
            ...
            <div class="col-md-6">
                ...
                <span style="display: flex;">
                    ...
                    <input type="number" name="price" class="form-control l-form-control l-field-e-2" placeholder="Price" onKeyPress="if(this.value.length==9) return false;" required>
                    <input list="quantityList" name="quantity" class="form-control l-form-control l-field-e-3" id="" placeholder="Quantity" maxlength="30" required>
                ...
                <div id="feature-div">
                    <span style="display: flex;" id="productFeature0">
                        <input list="productFeature" class="form-control l-form-control l-form-control-e l-field-e-3" id="" placeholder="Product Feature Title" name="productDetailLabel[]">
                        <input type="text" class="form-control l-form-control l-form-control-e l-field-e-2" placeholder="Feature" name="productDetailValue[]">
                ...
                <div class="display:flex;flex-direction:column">
                    ...
                    <input type="text" class="form-control uploadMedia" placeholder="Link" name="uploadVideo">
                </div>
            </div>
