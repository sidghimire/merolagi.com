$(document).ready(function() {
    ...
    $("#addBtn").on("click", function() {
        $("#feature-div").append('<span style="display: flex;" id="productFeature' + i + '"> <input list="productFeature" class="form-control l-form-control l-form-control-e l-field-e-3" id="" placeholder="Estate Feature (eg. Area)" name="productDetailLabel[]"> <input type="text" class="form-control l-form-control l-form-control-e l-field-e-2" placeholder="Feature (eg. 2.5 Anna )" name="productDetailValue[]"> <button class="btn btn-link l-feature-btn-remove" id="' + i + '">Remove</button> </span>');
        i++;
    });
