...
<body>
    ...
    <div class="l-container-padding text-center container-fluid">
        <div class=" l-container-title container-fluid text-left">
            <span class=" l-container-title-text">Add RealEstate Here</span>
        </div>
        <form action="action.php" method="POST" enctype="multipart/form-data" class=" l-main-container-section row no-gutters container-fluid " id="sellDiv">
            <div class="col-md-6" style="padding: 5px;">
                <div class="l-product detail-container">
                    ...
                    <input type="text" class="form-control l-form-control" placeholder="Estate Title (Eg. Land For Sale In Kalanki)" name="estateTitle" maxlength="50" required>
                    ...
                    <br>
                    <br>
                    <textarea name="estateDescription" id="productDescription" rows="10" cols="70" required></textarea>
                    <script>
            ...
            <div class="col-md-6">
                ...
                <div id="feature-div">
                    <span style="display: flex;" id="productFeature0">
                        <input list="productFeature" class="form-control l-form-control l-form-control-e l-field-e-3" id="" placeholder="Estate Feature (eg. Area)" name="productDetailLabel[]">
                        <input type="text" class="form-control l-form-control l-form-control-e l-field-e-2" placeholder="Feature (eg. 2.5 Anna )" name="productDetailValue[]">

                    </span>

                </div>
                <button type="button" class="btn btn-link" id="addBtn">Add +</button>
                ...
                <div class="display:flex;flex-direction:column" id="imageDiv">
                    ...
                    <input type="number" class="form-control uploadMedia" name="phone" placeholder="Phone Number" required>
                </div>
