...
if(isset($_GET['productId'])){
    $sqlAuthCheck2="SELECT employerUniqueId FROM `service_info` WHERE `productUniqueId`='".$_GET['productId']."'";
    ...
    <div class="container-fluid row no-gutters l-full-container">
        <div class="l-main-container container-fluid row no-gutters">
            <div class="col-md-4 l-product-info-col">
                ...
                <?php
                $sqlAllRequest = "SELECT * FROM `deal_services` WHERE productId='" . $_GET['productId'] . "'";
                    ...
                    <table class="table table-hover table-sm table-striped l-table">
                        ...
                        <tbody>
                            ...
                            while ($sqlAllRequestData = mysqli_fetch_assoc($sqlAllRequest)) {
                                $checkCompletion = "SELECT id FROM `transaction_service_complete` WHERE transactionId='" . $sqlAllRequestData['transactionId'] . "'";
                            ...
                            ?>
                                    ...
                                    ?>
                                    <td><?php echo $sqlAllRequestData['hiringTime'] ?> days</td>
                                    ...
                                    <td colspan="2">
                                        ...
                                        ?>
                                            ...
                                            <a href="/employer/manageServices/minechat/index.php?productId=<?php echo $sqlAllRequestData['productId'] ?>&transactionId=<?php echo $sqlAllRequestData['transactionId'] ?>" target="_blank">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="smallAction.php?productId=<?php echo $sqlAllRequestData['productId'] ?>&transactionId=<?php echo $sqlAllRequestData['transactionId'] ?>">
                                                        ...
                                                        <span class="l-transaction-label"> Hiring Time</span>
                                                        <div class="l-approve-unit row no-gutters">
                                                            <input type="number" name="hiringTime" class="form-control l-transaction-form-control-unit" placeholder="Hiring Time" required />
                                                        </div>
