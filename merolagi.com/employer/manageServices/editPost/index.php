...
<body>
    ...
    ?>
    <?php
    $sqlProductInfo = "SELECT * FROM `service_info` WHERE productUniqueId='" . $_GET['productId'] . "'";
    $sqlProductInfo = mysqli_query($conn2, $sqlProductInfo);
    $sqlProductInfoData = mysqli_fetch_assoc($sqlProductInfo);

    $sqlProductFeature = "SELECT * FROM `service_features` WHERE productUniqueId='" . $_GET['productId'] . "'";
    $sqlProductFeature = mysqli_query($conn2, $sqlProductFeature);

    $sqlProductImage = "SELECT * FROM `service_images` WHERE productUniqueId='" . $_GET['productId'] . "'";
    ...
    <div class="l-container-padding text-center container-fluid">
        ...
        <div class=" l-container-title container-fluid text-center">
            <span class=" l-container-title-text">Provide Services Here</span>
        </div>
        ...
        <form action="action.php?productId=<?php echo $_GET['productId']?>" method="POST" enctype="multipart/form-data" class=" l-main-container-section row no-gutters container-fluid" id="sellDiv">
            <div class="col-md-6" style="padding: 5px;">
                <div class="l-product detail-container">
                    ...
                    <input type="button" name="" value="Location You Want To Target Vacancy" onclick="getLocation();" data-toggle="modal" data-target="#mapping-div" class="btn btn-success w-100">
                    </div>
                    <input type="text" class="form-control l-form-control" placeholder="Service You Want To Provide" name="serviceName" maxlength="50" value="<?php echo ucwords($sqlProductInfoData['serviceName']) ?>" required>
                    ...
                    <br>
                    <br>
                    <textarea name="serviceDescription" id="productDescription" rows="10" cols="70" required><?php echo $sqlProductInfoData['serviceDescription'] ?></textarea>
                    <script>
            ...
            <div class="col-md-6">
                ...
                <span style="display: flex;">
                    <select class="form-control l-form-control l-field-e-1 w-50" name="currency" >
                    ...
                    <input type="number" name="price" value="<?php echo ucwords($sqlProductInfoData['price']) ?>" class="form-control l-form-control l-field-e-2 w-50" placeholder="Price" onKeyPress="if(this.value.length==9) return false;" >
                ...
                <div id="feature-div">
                    ...
                    ?>
                        <span style="display: flex;" id="productFeature0">
                            <input list="productFeature" class="form-control l-form-control l-form-control-e l-field-e-3" value="<?php echo ucwords($sqlProductFeatureData['productFeature']) ?>" id="" placeholder="Work Feature (eg. Skill)" name="productDetailLabel[]">
                            <input type="text" class="form-control l-form-control l-form-control-e l-field-e-2" value="<?php echo ucwords($sqlProductFeatureData['productFeatureValue']) ?>" placeholder="Feature (eg. Marketing )" name="productDetailValue[]">
                ...
                <div class="row no-gutters" style="display: flex;" id="img-container">
                    ...
                    ?>
                        <div class="l-uploaded-img-unit" id="l-uploaded-img-unit-div-<?php echo $j; ?>">
                            <img src="/res/database/serviceImages/<?php echo $sqlProductImageData['imageName'] ?>" class="l-product-image" alt="" srcset="">
                ...
                <div class="display:flex;flex-direction:column" id="imageDiv">
                    ...
                    <select class="form-control l-form-control" style="width: 100%;" name="workAnywhere" required>
                        <option value="<?php echo ucwords($sqlProductInfoData['workAnywhere']) ?>"><?php echo ucwords($sqlProductInfoData['workAnywhere']) ?></option>
                ...
                <div class="display:flex;" id="imageDiv">
                    ...
                    <?php
                    echo $sqlProductInfoData['activeStatus'];
                    if (ucwords($sqlProductInfoData['activeStatus']) == "On") {
                    ?>
                        <label class="switch">
