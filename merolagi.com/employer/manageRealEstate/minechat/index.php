...
if (isset($_GET['transactionId'])) {
    $sqlAuthCheck = "SELECT * FROM `deal_realestate` WHERE transactionId='" . $_GET['transactionId'] . "'";
    $sqlAuthCheck = mysqli_query($conn3, $sqlAuthCheck);
    $sqlAuthCheckData = mysqli_fetch_assoc($sqlAuthCheck);

    $sqlAuthCheck2 = "SELECT employerUniqueId FROM `realestate_info` WHERE `productUniqueId`='" . $sqlAuthCheckData['productId'] . "'";
            ...
            <div class="col-md-4 l-product-info-col">
                <div class="l-job-info-section container-fluid">
                    ...
                    <div class="row no-gutters">
                        ...
                        $sqlUserInfo = "SELECT * FROM `deal_realestate` WHERE transactionId='" . $transactionId . "'";
                        ...
                        if ($_SESSION['employerId'] != $sqlUserInfoData['customerId']) {
                            $getEmployerId = "SELECT employerUniqueId FROM realestate_info` where productUniqueId='" . $_GET['productId'] . "'";
            ...
            <div class="col-md-8" style="overflow-x: scroll;">
                <div class="l-responses-div">
                    ...
                    <div class="message-div">
                        ...
                        <?php
                        $sqlGetMessage = "SELECT * FROM `estate_message` WHERE transactionId='" . $_GET['transactionId'] . "' order by id limit 10";
                    ...
                    <form method="POST" action="insert.php" id="sendForm" class="message-input-div row no-gutters">
                        <textarea type="text" name="message" id="message" required class="form-control l-text-message-field col-10" placeholder="TextMessage"></textarea>
                        <div class="col-1">
