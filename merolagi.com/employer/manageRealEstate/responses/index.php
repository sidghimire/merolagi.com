...
if (isset($_GET['productId'])) {
    $sqlAuthCheck2 = "SELECT employerUniqueId FROM `realestate_info` WHERE `productUniqueId`='" . $_GET['productId'] . "'";
...
<?php
    ...
    <div class="container-fluid">
        <div class="row no-gutters text-left ">
            <a href="/employer/manageServices/index.php" class="col-2">
    ...
    <?php
    $sqlAllPost = "SELECT * FROM `realestate_info` WHERE productUniqueId='" . $_GET['productId'] . "'";
        ...
        <div class="l-main-container container-fluid row no-gutters">
            <div class="col-md-4 l-product-info-col">
                <div class="l-job-info-section container-fluid">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="l-product-description-div col-7">
                            <div class="l-feature-unit">
                                <div class="l-product-label"><?php echo ucwords($sqlAllPostData['estateTitle']) ?></div>
                            </div>
                            <div class="l-feature-unit">
                    ...
                    <a href="/estatedetail/<?php echo $sqlAllPostData['id'] ?>" target="_blank" class="l-view-post-btn btn btn-primary">
                        View Post
                    </a>
                </div>
                <?php
                $sqlAllRequest = "SELECT * FROM `deal_realestate` WHERE productId='" . $_GET['productId'] . "'";
                ...
                <div class="l-job-overview-section container-fluid">
                    ...
                    <a href="/frontend/estateDetail/index.php?productId=<?php echo $sqlAllPostData['productUniqueId'] ?>" target="_blank" class="l-view-post-btn btn btn-warning">
                        View Full Stats
                    </a>
                </div>
                    ...
                    <table class="table table-hover table-sm table-striped l-table">
                        ...
                        <tbody>
                            ...
                            while ($sqlAllRequestData = mysqli_fetch_assoc($sqlAllRequest)) {
                                $checkCompletion = "SELECT id FROM `transaction_realestate_complete` WHERE transactionId='" . $sqlAllRequestData['transactionId'] . "'";
                            ...
                            ?>
                                    ...
                                    <td colspan="2">
                                        ...
                                        ?>
                                            ...
                                            <a href="/employer/manageRealEstate/minechat/index.php?productId=<?php echo $sqlAllRequestData['productId'] ?>&transactionId=<?php echo $sqlAllRequestData['transactionId'] ?>" target="_blank">
